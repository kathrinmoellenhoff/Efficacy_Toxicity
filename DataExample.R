...
n <- 15 #patients per dose level (has to be adapted later on for the two datasets!)
...
######################################################
######################################################
# Study for regional differences
...
for (k in 1:B)
{
  ...
  #if(any(sapply(data1b, '[[', 1)!="0" & sapply(data1b, '[[', 1)!="1")){ next }
  ...
  #group2
  data2b <- gen_data(doses,minimum[6],minimum[7],minimum[8],minimum[9],minimum[10])
...
#################################################################
#################################################################
###Differences of the marketed and the investigational product###
#################################################################
#################################################################
...
######################################################
######################################################
#Option 1: two seperate models (see Supplementary Material)
...
t.stat2 <- d_t_hat
######################################################
#bootstrap test for three different margins
######################################################
